package com.example.echoapp.lib;
...
public class Utils
{
            ...
            strMsg)
    {
        ...
        // Use the AlertDialog's Builder Class methods to set the title, icon,
       // message, et al.
        ...
        alertDialogBuilder.setNeutralButton (context.getText (android.R.string.ok),
                listener);
        // Create and Show the Dialog
        alertDialogBuilder.show ();
    }
    /**
     * Overloaded XML version of showInfoDialog(Context context, String, String)
     method
     * @param context  The Context from which we can get access to resources
    ...
    public static  void showInfoDialog (Context context, int titleID, int msgID)
    {
        showInfoDialog (context,
                context.getText(titleID).toString (),
